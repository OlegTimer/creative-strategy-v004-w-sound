...
public class Attack3 {
    public static int check(int unitnum){
        ...
        arr = (int[]) Sol.buildlist.get(unitnum);//descr of attacker
        for (int n = arr[1]+1; n <Sol.mapheight-1; n++){//till the sky attacker
            if (Sol.map2[n][arr[2]][arr[3]]!=0){hdes=0;break;}}
        ...
        for (int i = 0; i < Sol.unitlist.size(); i++){
            ...
            if (name==1006){//tank howitzer pl1 is attacker
                if (hdes>0){
            ...
            if (name==3006){//tank howitzer pl2 is attacker
                if (hdes>0){
            ...
            if (name==1005){//air def pl1 is attacker
                if (hdes>0){//if up clear sky
                    if (arr[14]==2004 ){//if target is pl2 zepp
                        double dist1 = Math.sqrt((y1 - arr[2]) * (y1 - arr[2]) + (x1 - arr[3]) * (x1 - arr[3]));
                        double dist2 = Math.sqrt((y1 - arr[5]) * (y1 - arr[5]) + (x1 - arr[6]) * (x1 - arr[6]));
                        if (range>=dist1){
                            res=i; break;
            ...
            if (name==3005){//air def pl2 is attacker
                if (hdes>0){//if up clear sky
                    if (arr[14]==4 ){//if target is pl1 zepp
                        double dist1 = Math.sqrt((y1 - arr[2]) * (y1 - arr[2]) + (x1 - arr[3]) * (x1 - arr[3]));
                        double dist2 = Math.sqrt((y1 - arr[5]) * (y1 - arr[5]) + (x1 - arr[6]) * (x1 - arr[6]));
                        if (range>=dist1){
                            res=i; break;
            ...
            if (name==1007||name==3007){//car gun or tank pl1 or pl2 is attacker
                int n1,n2,n3; n1=n2=n3=-1;
                if (name==1007||name==8){n1=2000;n2=2004;n3=4000;}
                if (name==3007||name==2008){n1=2;n2=4;n3=2000;}
